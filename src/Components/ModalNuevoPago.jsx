...
const ModalNuevoPago = ({ onCancel, onPaymentRegistered }) => {
  ...
  const handleConfirmPayment = () => {
    ...
    setTimeout(() => {
      const { id, monto, fecha } = pendingPayment;
      ...
      // Devuelve el foco al input principal (con id "employeeId")
      document.getElementById("employeeId")?.focus();
    }, 2000);
  };

  // Si se cancela la confirmación, se cierra el modal y se devuelve el foco
  ...
  return (
    <div className="np-modal-overlay">
      {confirmPayment && pendingPayment ? (
        isProcessing ? (
          // Vista de procesamiento: spinner y mensaje
        ...
        // Vista del formulario de nuevo pago
        <div className="np-modal">
          ...
          <div className="np-modal-body">
            ...
            <div className="np-modal-actions">
              <button onClick={initiateConfirmation}>Registrar Pago</button>
            </div>
          </div>
        </div>
      )}
